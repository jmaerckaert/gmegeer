...
gme theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of gme theme and run the following commands:
`nvm use`
...
`drush en gme -y`
`drush config-set system.theme default gme -y`
